...
dwi2tensor dwi_den_preproc_unbiased.mif - | tensor2metric - -vec - | mrcalc - -abs FA.mif
...
tck2connectome tracks_10M.tck -tck_weights_in sift_1M.txt hcpmmp1_parcels_coreg.mif mean_FA_connectome.csv -scale_file mean_FA_per_streamline.csv -stat_edge mean
```
