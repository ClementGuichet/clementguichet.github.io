...
``` bash
#!/bin/bash
mri_aparc2aseg --old-ribbon --s <sub>_T1w_recon --annot hcpmmp1 --o hcpmmp1.mgz -force
...
for_each -nthreads <nproc --all> -info * : mri_aparc2aseg --old-ribbon --s IN_T1w_recon --annot hcpmmp1 --o IN/dwi/hcpmmp1.mgz -force
