...
for_each -nthreads 8 -info */dwi : dwi2tensor IN/dwi_den_preproc_unbiased.mif - \| tensor2metric - -fa - \| mrcalc - -abs IN/FA.mif
...
for_each -nthreads 8 -info * : tck2connectome -symmetric dwi/tracks_10M.tck -tck_weights_in dwi/sift_1M.txt dwi/hcpmmp1_parcels_coreg.mif dwi/IN_mean_FA_connectome.csv -scale_file dwi/IN_mean_FA_per_streamline.csv -stat_edge mean
```
...
-   NPROC: number of CPUs available on your machine
