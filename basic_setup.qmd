...
The pipelines works with Linux or [WSL2](https://learn.microsoft.com/fr-fr/windows/wsl/install) for Windows already installed on your system. It also assumes that you are familiar with the UNIX command line. Otherwise you can check this [tutorial](https://andysbrainbook.readthedocs.io/en/latest/unix/Unix_Intro.html).
