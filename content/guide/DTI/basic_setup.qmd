...
The pipelines work with Linux or [WSL2](https://learn.microsoft.com/fr-fr/windows/wsl/install) for Windows already installed on your system. I also assume you are familiar with the basic UNIX commands. Otherwise you can check this [tutorial](https://andysbrainbook.readthedocs.io/en/latest/unix/Unix_Intro.html).
