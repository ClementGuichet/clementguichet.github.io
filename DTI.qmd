...
This step can be speed up by using gnu parallel :
brew install gcc
...
Download the script below to run the entire pipeline
You may have to adapt it to your system specs (# of logical processors available) and to the size of your cohort
